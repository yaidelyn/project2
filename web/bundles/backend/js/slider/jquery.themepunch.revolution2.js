...
(function($,undefined){
    ...
    $.fn.extend({
        ...
        revolution: function(options) {
            ...
            return this.each(function() {
                ...
                if (!container.hasClass("revslider-initialised")) {
                    ...
                    container.find('.caption').each(function() { $(this).addClass('tp-caption2')});
                    container.find('.tp-caption2 iframe').each(function() {
                        try {
                    ...
                    // RESET THE TIMER
                    if (container.find('.tp-bannertimer2').length==0) container.append('<div class="tp-bannertimer2" style="visibility:hidden"></div>');
                    var bt=container.find('.tp-bannertimer2');
                    if (bt.length>0) {
                        bt.css({'width':'0%'});
                    };
        ...
        revpause: function(options) {
            ...
            return this.each(function() {
                ...
                var bt = container.parent().find('.tp-bannertimer2');
                bt.stop();
    ...
    function containerResized(container,opt) {
        ...
        container.find('.defaultimg').each(function(i) {
            ...
            container.find('.tp-caption2').each(function() { $(this).stop(true,true);});
    ...
    function createThumbs(container,opt) {
        ...
        if (opt.navigationType=="thumb" || opt.navsecond=="both") {
            cap.append('<div class="tp-bullets2 tp-thumbs '+opt.navigationStyle+'"><div class="tp-mask"><div class="tp-thumbcontainer"></div></div></div>');
        }
        var bullets = cap.find('.tp-bullets2.tp-thumbs .tp-mask .tp-thumbcontainer');
    ...
    function moveSelectedThumb(container) {
        ...
        var bullets=container.parent().find('.tp-bullets2.tp-thumbs .tp-mask .tp-thumbcontainer');
    ...
    function createBullets(container,opt) {
        ...
        if (opt.navigationType=="bullet"  || opt.navigationType=="both") {
            container.parent().append('<div class="tp-bullets2 simplebullets '+opt.navigationStyle+'"></div>');
        }


        var bullets = container.parent().find('.tp-bullets2');
    ...
    function createArrows(container,opt) {
        ...
        var bullets = container.find('.tp-bullets2');
    ...
    function hideThumbs(container,opt) {
        ...
        if (bullets==null) {
            container.append('<div class=".tp-bullets2"></div>');
            var bullets = container.parent().find('.tp-bullets2');
        }
    ...
    function setBulPos(container,opt) {
        ...
        var bullets=topcont.find('.tp-bullets2');
       ...
       // if (opt.navigationHAlign=="left")	bullets.css({'left':(0+opt.navigationHOffset)+"px"});
        if (opt.navigationHAlign=="left")	bullets.css({'left':'28%'});
    ...
    function prepareSlides(container,opt) {
        ...
        container.find('.tp-caption2').each(function() { $(this).addClass($(this).data('transition')); $(this).addClass('start') });
        ...
        container.find('>ul:first >li').each(function(j) {
            ...
            if (li.data('link')!=undefined) {
                ...
                if (link=="slide") {
                    li.append('<div class="tp-caption2 sft slidelink" style="z-index:'+zindex+';" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a><div></div></a></div>');
                } else {
                    linktoslide="no";
                    li.append('<div class="tp-caption2 sft slidelink" style="z-index:'+zindex+';" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a target="'+target+'" href="'+link+'"><div></div></a></div>');
                }
    ...
    function setCaptionPositions(container,opt) {
        ...
        var nextcaption=nextli.find('.tp-caption2');
    ...
    function onPlayerStateChange(event) {
        if (event.data == YT.PlayerState.PLAYING) {
            ...
            var bt = $('body').find('.tp-bannertimer2');
            var opt = bt.data('opt');
            bt.stop();
    ...
    function animateTheCaptions(nextli, opt,actli) {
        ...
        var offsetx=0;
        nextli.find('.tp-caption2').each(function(i) {
            ...
            var nextcaption=nextli.find('.tp-caption2:eq('+i+')');

            var handlecaption=0;

            // HIDE CAPTION IF RESOLUTION IS TOO LOW
            if (opt.width<opt.hideCaptionAtLimit && nextcaption.data('captionhidden')=="on") {
                nextcaption.addClass("tp-hidden-caption2")
                handlecaption=1;
            } else {
                if (opt.width<opt.hideAllCaptionAtLilmit)	{
                    ...
                    nextcaption.removeClass("tp-hidden-caption2")
                }
            }
        ...
        var bt=jQuery('body').find('#'+opt.container.attr('id')).find('.tp-bannertimer2');
        bt.data('opt',opt);
    }
    ...
    function removeTheCaptions(actli,opt) {
        ...
        actli.find('.tp-caption2').each(function(i) {
            var nextcaption=actli.find('.tp-caption2:eq('+i+')');
            nextcaption.stop(true,true);
            clearTimeout(nextcaption.data('timer'));
            clearTimeout(nextcaption.data('timer-end'));
            ...
            opt.cdint=setInterval(function() {
                ...
                if (opt.fullWidth!="on")
                    if (opt.width>opt.hideSliderAtLimit)
                        container.parent().removeClass("tp-hide-revslider2")
                    else
                        container.parent().addClass("tp-hide-revslider2")
                ...
                if (opt.cd>=opt.delay) {
                    ...
                    if (opt.stopLoop=="on" && opt.next==opt.lastslidetoshow-1) {
                        clearInterval(opt.cdint);
                        container.find('.tp-bannertimer2').css({'visibility':'hidden'});
