...
;(function($) {
    ...
    var methods = {
                ...
                $steps.each(function(index) {
                    ...
                    if (index == 0) {
                        ...
                        if (index < $steps.length - 1) {
                            methods.createNextButton.call($this, index);
                           //methods.createAddButton.call($this, index);
                        }
                    }
                });
        ...
        createBackButton: function(index) {
            ...
            $('<a/>', { id: id + '-add-' + index, href: 'javascript:void(0);', 'class': 'button-add  btn btn-default', html: opt.addLabel }).click(function() {
                if (!opt.add || methods.execute.call($this, opt.next, index + 1)) {
                    //methods.step.call($this, (index + 1) + 1);
                }
            }).appendTo($('#' + id + '-buttons-' + index));
        },
